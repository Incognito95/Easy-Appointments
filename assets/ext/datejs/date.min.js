...
Date.CultureInfo = {
    ...
    function () {
        ...
        i.clearTime = function () {
            ...
            for (var e = s.dayNames, n = s.abbreviatedDayNames, r = s.shortestDayNames, i = t.toLowerCase(), a = 0; a < e.length; a++)
                if (e[a].toLowerCase() == i || n[a].toLowerCase() == i || r[a].toLowerCase() == i) return a;
            return -1
        }, r.getMonthNumberFromName = function (t) {
            for (var e = s.monthNames, n = s.abbreviatedMonthNames, r = t.toLowerCase(), i = 0; i < e.length; i++)
                if (e[i].toLowerCase() == r || n[i].toLowerCase() == r) return i;
            return -1
            ...
            for (var e = s.timezones, n = 0; n < e.length; n++)
                if (e[n].offset === t) return e[n].name;
            return null
        }, r.getTimezoneOffset = function (t) {
            for (var e = s.timezones, n = 0; n < e.length; n++)
                if (e[n].name === t.toUpperCase()) return e[n].offset;
            return null
        }, i.clone = function () {
            ...
            var r, i, s, a, o, u, h;
            return t = t || this.getFullYear(), e = e || this.getMonth() + 1, n = n || this.getDate(), e <= 2 ? (h = (i = ((r = t - 1) / 4 | 0) - (r / 100 | 0) + (r / 400 | 0)) - (((r - 1) / 4 | 0) - ((r - 1) / 100 | 0) + ((r - 1) / 400 | 0)), s = 0, a = n - 1 + 31 * (e - 1)) : (s = (h = (i = ((r = t) / 4 | 0) - (r / 100 | 0) + (r / 400 | 0)) - (((r - 1) / 4 | 0) - ((r - 1) / 100 | 0) + ((r - 1) / 400 | 0))) + 1, a = n + (153 * (e - 3) + 2) / 5 + 58 + h), t = e = n = null, (u = a + 3 - (a + (o = (r + i) % 7) - s) % 7 | 0) < 0 ? 53 - ((o - h) / 5 | 0) : u > 364 + h ? 1 : 1 + (u / 7 | 0)
            ...
            return this.set({
                day: r.getDaysInMonth(this.getFullYear(), this.getMonth())
            })
        ...
        }), i._toString = i.toString, i.toString = function (t) {
            var e = this;
            if (t && 1 == t.length) {
    ...
    function () {
        ...
        for (var g = function (t) {
            ...
            }, p = 0; p < o.length; p++) e[i = o[p].toLowerCase()] = e[i + "s"] = g(o[p]), r[i] = r[i + "s"] = M(i);
        e._ss = g("Second");
